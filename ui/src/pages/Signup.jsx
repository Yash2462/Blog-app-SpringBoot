...
import { Loader2, AlertCircle, CheckCircle2, Eye, EyeOff, BookOpen } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 pt-20">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <h2 className="text-3xl font-black text-foreground tracking-tight uppercase">Create Account</h2>
          <p className="text-muted-foreground font-medium">Join our community of elite engineers.</p>
        </div>
